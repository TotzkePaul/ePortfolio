...
namespace ePortfolio.Databases
{
    public class DynamicDb
    {
        ...
        public bool ExcuteQuery(string procedureName, Object args, string schema = "")
        {
            RouteValueDictionary dbArgsDictionary;
            dbArgsDictionary = new RouteValueDictionary(args);
        ...
        public List<T> RunQuery<T>(Db type, string tableName, string[] args, string[] cols = null, string schema = "")
        {
            string sql = "";
        ...
        public T RunProcedure<T>(string procedureName, Object args, string schema = "")
        {
        ...
        public List<T> RunListProcedure<T>(string procedureName, Object args, string schema = "")
        {
            RouteValueDictionary dbArgsDictionary = new RouteValueDictionary(args);
            var dbArgs = new DynamicParameters();
            foreach (var pair in dbArgsDictionary)
        ...
        public List<T> CachedRunListProcedure<T>(string procedureName, Object args, string schema = "")
        {
            RouteValueDictionary dbArgsDictionary = new RouteValueDictionary(args);
            var dbArgs = new DynamicParameters();
            foreach (var pair in dbArgsDictionary)
        ...
        public void AsyncQuery(string procedureName, Object args, string schema = "")
        {
            RouteValueDictionary dbArgsDictionary = new RouteValueDictionary(args);
            var dbArgs = new DynamicParameters();
            foreach (var pair in dbArgsDictionary)
